...
p.corr <- ggpairs(dplyr::filter(comb_wide, ENG_mnDR > 0),columns = 1:5,
             ...
             diag = list(continuous = wrap(my_fn_diag,
                                           dens = list(aes(fill = locns, y = ..density..),
                                                       bins = 20,position = "identity",colour = "transparent", alpha = 0.65))),
...
grid.arrange(grobs = lapply(pl, "+", theme(plot.margin = unit(c(10,10,10,10), "points"))), ncol = 3, nrow = 4)
```
...
ggsave(plot = p.error,filename =  "results/Images/hist_error_11dist_singlescenario_seed977.pdf", width = 3.25, height = 3, units = "in",dpi = 600)
# Makawanpur
...
ggsave(plot = p.error_mak,filename =  "results/Images/hist_error_11dist_makawanpur_singlescenario_seed977.pdf", width = 3.25, height = 1.5, units = "in",dpi = 600)
# Nuwakot
...
ggsave(plot = p.error_nuw,filename =  "results/Images/hist_error_11dist_nuwakot_singlescenario_seed977.pdf", width = 3.25, height = 1.5, units = "in",dpi = 600)
