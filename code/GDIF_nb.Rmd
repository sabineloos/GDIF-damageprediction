...
***
<br>
In this notebook, we run through the basic steps to implement the geospatial data integration framework (G-DIF) presented in "A geospatial data integration framework to rapidly estimate post-disaster damage" by Sabine Loos , Jack Baker, David Lallemant, Nama Budhathoki, Sang-Ho Yun, Jamie McCaughey, Ritika Singh, and Feroz Khan, which is available online at [https://www.researchgate.net/publication/341946463_G-DIF_A_geospatial_data_integration_framework_to_rapidly_estimate_post-earthquake_damage](https://www.researchgate.net/publication/341946463_G-DIF_A_geospatial_data_integration_framework_to_rapidly_estimate_post-earthquake_damage).
